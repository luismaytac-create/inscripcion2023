...
class UniversidadController extends Controller
{
    ...
    public function data(Request $request){
        $universidad = Universidad::where('id',$request->id)->first();

        return view('admin.universidad.editar',compact('universidad'));
    }
    public function update(Request $request,$id){
        ...
        Alert::success('Universidad Actualizado con éxito');
        return back();
    }
}
