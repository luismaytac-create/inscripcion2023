...
class ListadoGeneralController extends Controller
{
    ...
    {
    	return view('admin.ingresantes.listados.general');
    }
    public function listadogeneralpdf()
    {
        ...
        foreach ($postulantes as $key => $postulante) {
            ...
            PDF::SetFont('helvetica', '', 10);
            PDF::Cell(20, 5, $postulante->codigo, 1, 1, 'C');
            #
            PDF::SetXY($x+40, $y*$altodecelda+$incremento);
            PDF::SetFont('helvetica', '', 10);
            PDF::Cell(20, 5, $postulante->numero_identificacion, 1, 1, 'C');
            #
            PDF::SetXY($x+60, $y*$altodecelda+$incremento);
            PDF::SetFont('helvetica', '', 10);
            PDF::Cell(90, 5, $postulante->nombre_completo, 1, 1, 'L');
