                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @if (PagoProspecto())
                                            ...
                                            <a href="{{ route('document.download','catalogo') }}" class="list-group-item"> Cat�logo de Especialidades </a>
                                           <a href="{{ route('document.download','guia') }}" class="list-group-item"> Gu�a de Inscripci�n </a>
