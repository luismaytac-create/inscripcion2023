                                ...
                                <div class="col-md-12">
                                    ...
                                    @else
                                        <div class="note note-danger">
                                            ...
                                            <p> Para poder descargar los documentos deberÃ¡ cancelar el Prospecto de admisiÃ³n en el banco bcp. <br>Puedes imprimir tu formato haciendo click <a href="{{ route('pagos.index') }}" target="blank">Aqui</a>  </p>
                                        </div>
                                    @endif
                                </div><!--span-->
                            </div><!--row-->
