            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        Relación de postulantes que no han finalizado su inscripción
                    </h3>
            ...
            columns: [
                ...
                },
                {
                    ...
                    'render': function ( data, type, row ) {
                        ...
                        if (data) {
                            return '<span class="m-badge m-badge--success">SUBIDO</span>';
                        }else{
                            return '<span class="m-badge m-badge--danger"> SIN DNI </span>';
