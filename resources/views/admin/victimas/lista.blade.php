            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        Relacion de Victima del Terrorismo que presentaron Documentos vía web.
                    </h3>
                ...
                @foreach ($Lista as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="evaluar-victima/{!! $item->dni !!}" class="btn btn-outline-info m-btn m-btn--custom m-btn--outline-2x" >
                                VER DOCUMENTOS
                            </a>
