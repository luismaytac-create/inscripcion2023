        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>EVALUAR VICTIMA DEL TERRORISMO </div>
                    <div class="tools">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            @else
                                                ...
                                                @endforeach
                                                {!! Form::open(['url' => 'admin/victimas-save', 'method' => 'post']) !!}
                                                ...
                                                <div class="form-group">
                                                    <a href="{!! url('/admin/solicitante-victima') !!}" class="btn btn-danger">ATRAS</a>
                                                </div>
                                                {!! Form::close() !!}
