                    ...
                    <div class="portlet light tasks-widget widget-comments">
                        ...
                        <div class="form-body ">
                            ...
                            <div class="row" id="datosdiv">
                                <h3>CONFIRMA QUE TU INFORMACIÓN PERSONAL Y FOTOGRAFÍA SEAN LAS CORRECTAS.
                            ...
                            <div id="divcnf1" class="col-md-12 ">
                                ...
                                <div id="divresp1" class="row m--padding-10">
                                    ...
                                    <div class="col-12">
                                        <button id="btndtcr" type="button" class="btn m-btn--pill btn-success btn-lg m-btn m-btn--custom">DATOS CORRECTOS</button>
