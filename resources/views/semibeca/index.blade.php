    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--creative m-portlet--first m-portlet--bordered-semi">
            ...
            <div class="m-portlet__body lead">
                ...
                <p> Documento 4: Boletas de pago o recibos por honorarios de tu padre y de tu madre, correspondiente a los dos últimos meses (Mayo- Junio 2025). </p>
                            ...
                            <div class="m-portlet m-portlet--bordered m-portlet--bordered-semi m-portlet--rounded">
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <div  class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group m-form__group">
                                                <strong>4. Boletas de pago o recibos por honorarios de tu padre y de tu madre, correspondiente a los dos últimos meses (Mayo- Junio 2025).</strong>
                                    ...
                                    <div  class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group m-form__group">
                                                <strong>6. Recibo de agua, energía eléctrica y teléfono de la vivienda que ocupa el postulante en la ciudad de Lima, correspondiente a los dos últimos meses (Mayo- Junio 2025).</strong>
