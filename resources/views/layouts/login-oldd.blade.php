...
<head>
    <meta charset="utf-8" />
    <title>Concurso de Admisión | Ingresar</title>
    <meta name="description" content="Admisión UNI | Universidad Nacional de Ingeniería | Ingreso Escolar Nacional | IEN ">
    ...
    <link href="{{asset('assets2/demo/base/style.bundle.css')}}" rel="stylesheet" type="text/css" />

<!--RTL version:<link href="{{asset('assets2/demo/base/style.bundle.rtl.css')}}" rel="stylesheet" type="text/css" />-->
...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-grid--tablet-and-mobile m-grid--hor-tablet-and-mobile m-login m-login--1 m-login--signin" id="m_login">
        ...
        <div class="m-grid__item m-grid__item--order-tablet-and-mobile-2 m-login__aside" style="background-image: url({{asset('assets2/app/media/img//bg/bg-3.jpg')}})">

            @yield('content')

        </div>
        <div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1	m-login__content m-grid-item--center" style="background-image: url({{asset('assets2/app/media/img//bg/bg-3.jpg')}})">
            <img class="img-fluid" src="{{asset('assets/pages/img/banocad.jpg')}}">
...
<script src="{{asset('assets2/demo/base/scripts.bundle.js')}}" type="text/javascript"></script>

<!--end::Global Theme Bundle -->

<!--begin::Page Scripts -->
<script src="{{asset('assets2/snippets/custom/pages/user/login.js')}}" type="text/javascript"></script>
