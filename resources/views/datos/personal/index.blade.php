    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--creative m-portlet--first m-portlet--bordered-semi">
            ...
            <div class="m-portlet__body lead">
                ...
                <dl>
                    <dt>Observación</dt>
                    <dd>Los nombres y apellidos deben coincidir de tu DNI, <strong>todos los campos son obligatorios.</strong></dd>
                </dl>
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 Colegio">
                        ...
                        <div id="colediv" class="col-md-12">
                            ...
                            @if(Request::old('idcolegio') == NULL)
                                ...
                                {!!Field::select('idcolegio',null,['style'=>'width: 100%','label'=>'Escoger el colegio(*)']);!!}
                            @endif
                    ...
                    <div class="col-md-6 Universidad">
                        ...
                        @if(Request::old('iduniversidad') == NULL)
                            ...
                            {!!Field::select('iduniversidad',null,['style'=>'width: 100%','label'=>'Escoger Universidad(*)']);!!}
                        @endif
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                for ( var key in respuesta.data) {
                    ...
                    var nom = "FACULTAD DE " + respuesta.data[key].nombre;
                    var id = respuesta.data[key].id;
